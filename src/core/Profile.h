...
class Profile {
 protected:
  ...
  void init(ProfileType pt, const wchar_t* _ipUsername, const wchar_t* _password, const wchar_t* _charname,
            const wchar_t* _gateway, const wchar_t _diff, unsigned int _maxLoginTime, unsigned int _maxCharTime) {
    type = pt;
 ...
 public:
  ...
  Profile(ProfileType pt, const wchar_t* account, const wchar_t* _pass, const wchar_t* _charname,
