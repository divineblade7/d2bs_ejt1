...
#include "diablo/patches/D2Intercepts.h"
...
PatchHook Patches[] = {
    ...
    {PatchCall, GetDllOffset("D2Client.dll", 0x5F802), (DWORD)GamePacketReceived_Intercept,
     5},  // Updated 1.14d //0045F802-BASE
    {PatchJmp, GetDllOffset("D2Client.dll", 0x12AE5A), (DWORD)GamePacketSent_Interception,
     5},  // Updated 1.14d //0052AE5A-BASE
    {PatchCall, GetDllOffset("D2Client.dll", 0x62D72), (DWORD)GetSelectedUnit_Intercept,
     5},  // Updated 1.14d //00462D72-BASE
    {PatchJmp, GetDllOffset("D2Client.dll", 0x5E4D5), (DWORD)PlayerAssignment_Intercept,
    ...
    {PatchCall, GetDllOffset("D2Client.dll", 0x4EBEF), (DWORD)CongratsScreen_Intercept,
     5},  // Updated 1.14d //0044EBEF-BASE
    {PatchCall, GetDllOffset("D2Client.dll", 0x547B6), (DWORD)GameActChange_Intercept,
     5},  // Updated 1.14d //004547B6-BASE
    {PatchJmp, GetDllOffset("D2Client.dll", 0x567EB), (DWORD)GameActChange2_Intercept,
    ...
    {PatchCall, GetDllOffset("D2Client.dll", 0x61704), (DWORD)GameAttack_Intercept,
     5},  // Updated 1.14d //00461704-BASE
    //	{PatchCall,	GetDllOffset("D2Client.dll", 0xA7364),	(DWORD)AddUnit_Intercept, 5}, 	{PatchCall,
    //GetDllOffset("D2Client.dll", 0xA6F25),	(DWORD)RemoveUnit_Interept,			9},

    // this patch needs a constant in ChatPacketRecv_Interception updated also
    {PatchCall, GetDllOffset("BNCLIENT.DLL", 0x121B20), (DWORD)ChatPacketRecv_Interception,
    ...
    {PatchCall, GetDllOffset("D2Multi.dll", 0x42A61), (DWORD)ChannelInput_Intercept,
     5},  // Updated 1.14d //00442A61-BASE

    //{PatchCall,	GetDllOffset("D2Multi.dll", 0x14A9A),	(DWORD)ChannelWhisper_Intercept,		5},//1.13d //not
    //used {PatchJmp,	GetDllOffset("D2Multi.dll", 0x14BE0),	(DWORD)ChannelChat_Intercept, 6},//1.13d {PatchJmp,
    //GetDllOffset("D2Multi.dll", 0x14850),	(DWORD)ChannelEmote_Intercept,			6},//1.13d
...
PatchHook Conditional[] = {
    {PatchJmp, GetDllOffset("BNCLIENT.DLL", 0x12366C), (DWORD)ClassicSTUB, 5,
     &Vars.bUseRawCDKey},  // Updated 1.14d //0052366C-BASE
    {PatchJmp, GetDllOffset("BNCLIENT.DLL", 0x123958), (DWORD)LodSTUB, 5,
