...
// #define JSAPI_EMPTY_CTOR(name) JSBool name##(JSContext* cx, uint argc, jsval* vp) { return THROW_ERROR(cx, "Invalid
// Operation");}
#define EMPTY_CTOR(name) \
...
#define JSCLASS_DEFAULT_WITH_CTOR(ctor)                                                                    \
  JSCLASS_SPEC(JS_PropertyStub, JS_PropertyStub, JS_PropertyStub, JS_StrictPropertyStub, JS_EnumerateStub, \
               JS_ResolveStub, JS_ConvertStub, JS_FinalizeStub, ctor)

#define JSCLASS_DEFAULT_STANDARD_MEMBERS                                                                      \
  JS_PropertyStub, JS_PropertyStub, JS_PropertyStub, JS_StrictPropertyStub, JS_EnumerateStub, JS_ResolveStub, \
...
inline JSBool __fastcall JS_ArrayToVector(JSContext* cx, JSObject* arr, std::vector<T>& vec) {
  ...
  if (!JS_IsArrayObject(cx, arr)) THROW_ERROR(cx, "Object must be an Array");
