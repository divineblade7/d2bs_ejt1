...
class TimedAlloc {
 ...
 public:
  ...
  void DumpStats(FILE* f) const {
    ...
    double realalloctime = (alloctime / freq), realdealloctime = (dealloctime / freq), realctortime = (ctortime / freq),
           realdtortime = (dtortime / freq), allocperpsec = (allocs == 0 ? 0 : realalloctime * 1000 / allocs),
    ...
    fprintf(
        ...
        allocs, deallocs, ctors, dtors, realalloctime, allocperpsec, realdealloctime, deallocperpsec, realctortime,
        realdtortime, ctorperobj, dtorperobj);
  }
};
